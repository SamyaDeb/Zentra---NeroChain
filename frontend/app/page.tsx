            ...
            >
              <div className="flex items-center gap-2 opacity-70 hover:opacity-100 transition-opacity duration-300">
                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <text x="20" y="25" textAnchor="middle" fill="white" fontSize="12" fontWeight="bold">N</text>
                </svg>
                <span className="text-white/80 font-medium text-sm">NERO</span>
              </div>
              <Image 
      ...
      <section id="about" className="relative bg-black min-h-screen overflow-hidden">
        ...
        <div className="relative text-white pt-[70px]" style={{ zIndex: 10 }}>
          <div className="mx-auto max-w-[1300px] px-6">
            ...
            >
              Experience seamless lending in simple steps on NERO Chain.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-[50px]">
              ...
              >
                ...
                <p className="text-white/70 leading-relaxed mb-6 font-normal text-sm">Start your journey by securely linking your wallet. Zentra uses your wallet as your identity-no sign-ups or passwords.</p>
                <ul className="space-y-3 mb-6 flex-grow">
                  ...
                  <li className="flex items-center text-xs text-white/70">
                    <div className="w-1.5 h-1.5 bg-[#C0C0C0]/70 rounded-full mr-3 flex-shrink-0"></div>
                    <span className="font-normal">Detects NERO Chain network</span>
                  </li>
                  <li className="flex items-center text-xs text-white/70">
                    <div className="w-1.5 h-1.5 bg-[#C0C0C0]/70 rounded-full mr-3 flex-shrink-0"></div>
